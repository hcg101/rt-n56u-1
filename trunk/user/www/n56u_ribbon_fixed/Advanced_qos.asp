...
function applyRule(){
    ...
    if(validForm()){
        ...
        document.form.current_page.value = "/Advanced_qos.asp";
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <div class="box well grad_colour_dark_blue">
                            ...
                            <h2 class="box_head round_top">qos 设置</h2>
                            ...
                            <div class="round_bottom">
                                ...
                                <div class="row-fluid">
                                  ...
                                  <div class="alert alert-info" style="margin: 10px;">不是智能qos，应该说是Ip带宽分配
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th width="30%" style="border: 0 none;">启用 qos</th>
                                            ...
                                            <td style="border: 0 none;">
                                                ...
                                                <div class="main_itoggle">
                                                    ...
                                                    <div id="wifidog_enable_on_of">
                                                        ...
                                                        <input type="checkbox" id="wifidog_enable_fake" <% nvram_match_x("", "qos_enable", "1", "value=1 checked"); %><% nvram_match_x("", "qos_enable", "0", "value=0"); %>  />
                                                ...
                                                <div style="position: absolute; margin-left: -10000px;">
                                                    ...
                                                    <input type="radio" value="1" name="qos_enable" id="qos_enable_1" class="input" value="1" <% nvram_match_x("", "qos_enable", "1", "checked"); %> /><#checkbox_Yes#>

                                                    <input type="radio" value="0" name="qos_enable" id="qos_enable_0" class="input" value="0" <% nvram_match_x("", "qos_enable", "0", "checked"); %> /><#checkbox_No#>
										...
										<tr>
                                            ...
                                            <th colspan="2" style="background-color: #E3E3E3;">qos参数设置</th>
