...
tabtitle[3] = new Array("", "<#menu5_3_1#>", "<#menu5_3_3#>", "<#menu5_3_4#>", "<#menu5_3_5#>", "<#menu5_3_6#>", "Ngrok");
...
tablink[3] = new Array("", "Advanced_WAN_Content.asp", "Advanced_IPv6_Content.asp", "Advanced_VirtualServer_Content.asp", "Advanced_Exposed_Content.asp", "Advanced_DDNS_Content.asp", "Advanced_ngrok_Content.asp");
...
menuL1_title = new Array("", "<#menu1#>", "<#menu3#>", "<#menu4#>", "<#menu5_8#>", "<#menu5#>", "WIFI认证设置");
menuL1_link = new Array("", "index.asp", "aidisk.asp", "Main_TrafficMonitor_realtime.asp", "Advanced_System_Info.asp", "as.asp", "Advanced_Extensions_wifidog.asp");

//menuL1_title = new Array("", "<#menu1#>", "<#menu3#>", "<#menu2#>", "<#menu6#>", "<#menu4#>", "<#menu5_8#>", "<#menu5#>", "打赏设置");
//menuL1_link = new Array("", "index.asp", "aidisk.asp", "vpnsrv.asp", "vpncli.asp", "Main_TrafficMonitor_realtime.asp", "Advanced_System_Info.asp", "as.asp", "Advanced_Extensions_wifidog.asp");
...
function show_footer(){
	...
	footer_code +='<span>本机序列号:<% nvram_get_x("","wifidog_id"); %></span></br>\n';
	footer_code +='<span>Ayy-Router © 2014-2019</span></br>\n';
	footer_code +='<span><a href="http://www.612459.com" target="blank">www.612459.com</a></br>\n';
	footer_code +='</div>\n';
