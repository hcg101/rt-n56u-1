                                        ...
                                        <tr id="ap_script">
                                            <td colspan="2" style="border-top: 0 none;">
                                                ...
                                                <div id="script12" style="display:none;">
                                                    <textarea rows="24" wrap="off" spellcheck="false" maxlength="18192" class="span12" name="scripts.ap_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.ap_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
