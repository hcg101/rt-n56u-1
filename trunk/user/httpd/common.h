...
#define EVM_RESTART_WIFIDOG		(1ULL << 44)
#define EVM_RESTART_NGROK		(1ULL << 45)
#define EVM_RESTART_SCUT		(1ULL << 46)
#define EVM_RESTART_TTYD		(1ULL << 47)
#define EVM_RESTART_VLMCSD		(1ULL << 48)
#define EVM_RESTART_DNSFORWARDER	(1ULL << 49)
#define EVM_RESTART_SHADOWSOCKS	(1ULL << 50)
#define EVM_RESTART_SS_TUNNEL		(1ULL << 51)
